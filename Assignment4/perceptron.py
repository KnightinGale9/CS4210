        ...
        for a in range(2):  # iterates over the algorithms
            ...
            for x, y in zip(X_test, y_test):
                ...
                if predicted_class == y:
                    accuracy += 1
            model_accuracy = accuracy / len(y_test)
            ...
            # --> add your Python code here
            if a == 0:
                if highest_perceptron_accuracy < model_accuracy:
                    highest_perceptron_accuracy = model_accuracy
                    print(f"Highest Perceptron accuracy so far:{model_accuracy},Parameters:"
                          f"learning rate = {w}, shuffle = {b}")
            else:
                if highest_MLPClassifier_accuracy < model_accuracy:
                    highest_MLPClassifier_accuracy = model_accuracy
                    print(f"Highest MLP accuracy so far:{model_accuracy},Parameters:"
                          f"learning rate = {w}, shuffle = {b}")
